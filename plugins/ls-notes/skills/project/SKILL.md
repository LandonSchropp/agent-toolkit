...
The board file is a kanban board. **REQUIRED:** Read [Kanban Boards](references/kanban.md). Its rules apply to every board file in the vault, including the ones outside `Projects/`.

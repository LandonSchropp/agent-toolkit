...
Always run the script in the background with a long Bash tool timeout (600000ms). After running the command, print a short message provided by the calling skill to let the user know it has been opened. You're notified when the window closes.

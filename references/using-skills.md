Before doing anything else, you **MUST** read `reviews.md` and follow its instructions exactly.
...
| "They basically approved the commit" | Read `reviews.md`; it defines the only approval that counts. |
| "They said the changes look good"    | Read `reviews.md`; looking good is not commit approval.      |
